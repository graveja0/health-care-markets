...
Commuting zones are comprised of geographically contiguous counties with strong wtihin-area clustering of commuting ties between residental and work county, and weak across-area ties. 

More recent data are available [here](https://www.census.gov/data/tables/time-series/demo/commuting/commuting-flows.html).
