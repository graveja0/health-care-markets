...
The objective of this repository is to lay out some thoughts, analytics, and data for defining geographic markets for health care services in the U.S.

Geographic market definitions are important for a wide variety of regulatory and research uses. Therefore, for any given measure (e.g., a Herfindahl-Hirschman index of market concentration) it is important to know whether and how that measure varies by alternative market definitions. Moreover, commonly used geographies, such as hospital referral regions (HRRs), commuting zones (CZs), metropolitan statistical areas (MSAs), etc. have both strengths and weaknesses. Whether the strengths outweigh the weaknesses will depend on the specific question at hand. As just one example, the latest commuting zone data are derived from commuting patterns ascertained in the 2000 Census; HRRs and HSAs are defined by patient hospital flows in 1992-1993. Obviously, flows of both patients and commuters have changed substantially in some areas in the last 20-30 years--whether these changes are material to defining geographic boundaries of contemporary health care markets remains an open question.
