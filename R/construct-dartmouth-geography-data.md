...
zcta_map_shape <- readShapeSpatial(here("public-data/shape-files/zcta-2017/tl_2017_us_zcta510/tl_2017_us_zcta510"))
```
...
```
    ...
    ## Warning in gBuffer(., byid = TRUE, width = 0): Polygons object missing
...
#########################
  ...
  hrr_map_simple <- gSimplify(hrr_map, tol = 200)
...
``` r
  ...
  pcsa_map_simple <- gSimplify(pcsa_map, tol = 200)
